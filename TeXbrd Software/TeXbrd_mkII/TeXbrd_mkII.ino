...
const byte COLS = 16;   //fourteen columns
const byte ROWS = 6;    //six rows
byte colPins[COLS] = {19,14,15,16,17,25,26,21,20,12,11,10,9,8,22,23};
...
unsigned int key_matrix[ROWS][COLS] = {
  ...
  {KEY_TILDE,KEY_1,KEY_2,KEY_3,KEY_4,KEY_5,KEY_6,KEY_7,KEY_8,KEY_9,KEY_0,KEY_MINUS,KEY_EQUAL,KEY_BACKSPACE,KEY_NONE,KEY_NONE},
